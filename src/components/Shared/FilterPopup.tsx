...
export function FilterPopup(props: Props): React.ReactElement<Props, any> {
  ...
  async function handleSave() {
    try {
      ...
      const filterResponse: IFiltersResponse = await FiltersService.upsert({
        userId: loggedUserContext.loggedUser._id,
        filters: filterContex.filters,
      });
        ...
        <PopupContent>
          ...
          <div id="body">
            ...
            <div id="right">
              <div
                id="age-range"
                style={{ height: `calc(100% - (100% - ${ageRangeHeight}px))` }}
                className="row"
              >
                <p>Age Range:</p>
                <div className="ages">
                  <input
                    ...
                    placeholder="Min"
                    maxLength={2}
                    onChange={(e: any) => handleAgeRangeChange(e, true)}
                  ></input>
                  <p>to</p>
                  <input
                    ref={maxAgeInput}
                    ...
                    placeholder="Max"
                    maxLength={2}
                    onChange={(e: any) => handleAgeRangeChange(e, false)}
                  ></input>
                </div>
              </div>
              <div
